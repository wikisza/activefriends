-- ============================================================
-- Fix: triggery potrzebują móc wstawiać do notifications
-- bez blokady RLS (auth.uid() = NULL w kontekście triggera)
-- ============================================================

-- Usuń politykę INSERT dla użytkowników - wstawiają tylko triggery
DROP POLICY IF EXISTS "notifications_insert" ON public.notifications;

-- Triggery uruchamiają się jako postgres (superuser), ale
-- SECURITY DEFINER + SET row_security = off zapewnia ominięcie RLS
...
BEGIN
  ...
  SELECT author_id, title INTO v_topic_author, v_topic_title
    FROM public.forum_topics WHERE id = NEW.topic_id;
